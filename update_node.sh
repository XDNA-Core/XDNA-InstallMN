...
TARBALLURL="https://github.com/XDNA-Core/XDNA/releases/download/v1.2.1.0/ubuntu16.04-daemon.zip"
TARBALLNAME="ubuntu16.04-daemon.zip"
XDNAVERSION="1.2.1.0"

clear
echo "This script will update your masternode to version 1.2.1.0"
